...
def unAbMaxPooling(inputs, argmax, ksize, strides=2):
...
class Cnn_AE_1:
    ...
    def build_model(self, input_shape):
        ...
        deconv1_unpool = Lambda(unAbMaxPooling, arguments={'argmax': conv3_argmax, 'ksize': [1, 1, 2, 1]}, name='unAbPool1')(deconv1)
        ...
        deconv2_unpool = Lambda(unAbMaxPooling, arguments={'argmax': conv2_argmax, 'ksize': [1, 1, 2, 1]}, name='unAbPool2')(deconv2)
        ...
        deconv3_unpool = Lambda(unAbMaxPooling, arguments={'argmax': conv1_argmax, 'ksize': [1, 1, 2, 1]}, name='unAbPool3')(deconv3)
